...
<p>Это тестовый вариант от 14.08.2015 (содержание полупроизвольное). Обновляйте страницу (!), чтобы увидеть последний вариант.
<!--Начало уч.занятий 1 сентября для 5-6 курсов и 8 сентября для 1-4 курсов (на первой неделе у них пересдачи и у 1 курса тестирование). У всех неделя с 1 сент. по числителю, с 8 сентября по знаменателю.
-->
</p>
<p/>
